...
func GetMachineDeployment(ctx context.Context, client client.Client, cluster *anywherev1.Cluster, machineDeploymentName string) (*clusterv1.MachineDeployment, error) {
